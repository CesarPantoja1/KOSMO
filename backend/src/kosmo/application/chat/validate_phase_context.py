...
_PHASE_CLASSIFICATION_PROMPT = (
    ...
    "   - Estrategia comercial, modelo de negocio, diferenciadores globales.\n"
    "   - Palabras clave: visión, negocio, mercado, propuesta de valor, alcance general, actores, "
    "metas, problema.\n\n"
    ...
    "   - Reglas de negocio o lógica específica de una funcionalidad (ej. descuentos, roles, cálculos).\n"
    "   - NO incluye detalles técnicos profundos de implementación (APIs, bases de datos, código).\n"
    "   - Palabras clave: característica, funcionalidad, título, descripción, origen, "
    "acción de usuario, cálculo, regla, tipos, C01, C02.\n\n"
    ...
    "}\n\n"
    "REGLAS:\n"
    "- SÉ MUY PERMISIVO. Si el mensaje puede interpretarse razonablemente dentro "
    "de la fase actual, DEBES considerarlo válido (target_phase y message vacíos).\n"
    "- Si el usuario describe una característica, funcionalidad o regla de negocio "
    "relacionada con una funcionalidad, y la fase actual es 'features', ES VÁLIDO.\n"
    "- Si el mensaje NO corresponde EVIDENTEMENTE a la fase actual, target_phase debe "
    "contener la fase correcta y message un texto breve.\n"
    ...
    "- Si el mensaje ES válido para la fase actual, target_phase y message van vacíos."
)
