...
_DISCOVERY_SYSTEM_PROMPT = (
    ...
    "No uses el guion largo (—) en el texto. Usa punto, coma o dos puntos en su lugar.\n\n"
    "## Visión del producto\n\n"
    ...
    "negocio, seguido de una declaración verificable y alcanzable exclusivamente "
    "con el producto implementado. Formato:\n"
    "'1. **Título del área:** declaración verificable de lo que el producto "
    "entrega por sí mismo.'\n"
    "Mínimo 2. Las metas NO describen escenarios de interacción ni nombran actores "
    "específicos.\n"
    "PROHIBIDO en metas: satisfacción del cliente, percepción del usuario, estados "
    "emocionales (sentirse seguro, sentirse mejor, sentirse tranquilo), eliminar "
    "conflictos o discusiones, mejorar la experiencia, ni cualquier resultado que "
    "dependa del comportamiento humano y no del producto. Las metas deben ser "
    "observables y medibles en el funcionamiento del producto.\n"
    "Ejemplo válido: 'los saldos se recalculan automáticamente al registrar un gasto'.\n"
    "Ejemplo inválido: 'los usuarios se sienten satisfechos con la transparencia'.]\n\n"
    "## Reglas de negocio\n\n"
    ...
    "- Las metas son declaraciones verificables que el producto puede cumplir "
    "por sí mismo, sin depender de percepciones, emociones o comportamientos "
    "humanos (prohibido: satisfacción, sentirse mejor, eliminar conflictos).\n"
...
class DiscoveryMode:
    ...
    def build_retry_prompt(
        ...
        return (
            ...
            f"del producto son declaraciones verificables que el producto puede cumplir "
            f"por sí mismo (sin percepción del usuario, emociones ni satisfacción)."
        )
