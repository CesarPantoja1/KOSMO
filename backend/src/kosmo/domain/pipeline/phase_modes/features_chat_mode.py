...
_FEATURES_CHAT_SYSTEM_PROMPT = (
    ...
    "- NUNCA categorices automáticamente los cambios como 'Futuro potencial'. "
    "Asume que los cambios solicitados son para el alcance actual de la característica, "
    "a menos que el usuario diga lo contrario.\n\n"
    "COMPORTAMIENTO:\n"
