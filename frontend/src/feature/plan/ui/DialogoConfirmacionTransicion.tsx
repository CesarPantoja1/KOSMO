...
import { ButtonLG } from '@/shared/ui/button';
		...
		>
			...
			>
				<div className="text-center">
					...
					<h3 className="text-2xl font-bold text-base-950 mb-2">
						Cambios sin aplicar
					</h3>
						...
						<div className="flex">
							...
							<div className="ml-3">
								<p className="text-sm text-yellow-700">
									El impacto de estos cambios afectará a: <strong className="font-semibold">{impactedPhases.join(', ')}</strong>.
								</p>
							</div>
						</div>
					</div>
				...
				<div className="flex flex-col sm:flex-row justify-between gap-3 mt-4">
					<ButtonLG variant="destructive" onClick={onDiscard}>
						Descartar plan
					</ButtonLG>
					<div className="flex flex-col sm:flex-row gap-3">
						<ButtonLG variant="secondary" onClick={onPostpone}>
							Dejar para después
						</ButtonLG>
						<ButtonLG variant="primary" onClick={onReview}>
							Revisar y aplicar
						</ButtonLG>
					</div>
				</div>
