		...
		<div className='warning-popup' onClick={onCancel}>
			...
			>
				...
				<p className='text-neutral-500 text-sm text-center leading-relaxed'>
					El repositorio <span className='font-mono text-neutral-700'>{repoName}</span> será
					visible por cualquier persona y el código fuente quedará expuesto públicamente.
				</p>
				<div className='flex justify-center gap-3 mt-6'>
					<button type='button' className='btn btn-secondary' onClick={onCancel} disabled={confirmLoading}>
						Cancelar
					</button>
					<button
						type='button'
