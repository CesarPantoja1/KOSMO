	...
	return (
		<section className='page-container'>
			...
			{loading ? (
				...
				<div className='flex gap-4 flex-wrap px-0.5'>
					<Link
						href='/crear-proyecto'
						className='w-96 h-40 px-5 pt-7 pb-2.5 bg-base-50 rounded-sm shadow-[0px_4px_8px_0px_rgba(0,0,0,0.20)] outline-1 outline-black inline-flex flex-col justify-start items-start gap-4 overflow-hidden'
					>
					...
					{projects.map((project) => (
						<article
							...
							className='flex h-40 w-96 cursor-pointer flex-col rounded-sm bg-white p-5 shadow-md transition-colors hover:bg-gray-50'
						>
							<header>
							...
							<p className='mt-4 line-clamp-3 text-base text-base-600 capitalize'>
				...
				<div className='bg-base-100/15 flex flex-col gap-2.5 px-0.5'>
					<table className=''>
						<thead>
