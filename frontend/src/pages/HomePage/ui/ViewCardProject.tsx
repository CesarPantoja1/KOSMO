			...
			<div className='grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-5 max-w-450'>
				...
				{projects.map((project) => (
					<article
						...
						className='group relative flex min-h-40 cursor-pointer flex-col rounded-lg bg-neutral-0 p-5 shadow-sm border border-neutral-200 transition-all hover:shadow-md hover:scale-95 hover:border-neutral-300'
					>
						<button
							onClick={(e) => {
								e.stopPropagation();
							...
							className='absolute top-2 right-2 p-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-error-50 cursor-pointer'
