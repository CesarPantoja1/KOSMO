...
import { useAiConfigStore } from '@/entities/user/model/ai-config-store';
import { AiConfigForm } from '@/entities/user/ui/AiConfigForm';
	...
	return (
		<div className='flex flex-col gap-6 animate-fade-in'>
			<div className='bg-neutral-0 border border-neutral-200 rounded-xl shadow-sm p-6'>
				<h3 className='text-lg font-semibold text-neutral-800 mb-4'>Información del usuario</h3>
				<div className='flex flex-col gap-4'>
					<div>
						<label className='text-neutral-500 text-sm font-medium mb-1.5 block'>Subject</label>
						<p className='text-neutral-800 font-mono text-sm bg-neutral-50 border border-neutral-300 rounded-lg px-3 py-2.5'>
							{subject}
						</p>
					</div>
					<div>
						<label className='text-neutral-500 text-sm font-medium mb-1.5 block'>Scopes</label>
					...
					<div>
						<label className='text-neutral-500 text-sm font-medium mb-1.5 block'>Estado</label>
