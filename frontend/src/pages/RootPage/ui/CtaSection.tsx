...
export function CtaSection({ onComenzar }: CtaSectionProps) {
	return (
		<section className='relative overflow-hidden border-t border-neutral-200 bg-linear-to-r from-ai-500 to-ai-600 py-20'>
			...
			<div className='relative mx-auto max-w-4xl px-6 text-center'>
				...
				<button
					onClick={onComenzar}
					className='mt-8 rounded-xl bg-neutral-0 px-7 py-3.5 font-semibold text-ai-600 shadow-xl transition hover:-translate-y-0.5 cursor-pointer'
				>
					Comenzar ahora →
				</button>

				<p className='mt-5 text-xs text-ai-100'>Necesitas un API Key para comenzar.</p>
			</div>
		</section>
	);
}
