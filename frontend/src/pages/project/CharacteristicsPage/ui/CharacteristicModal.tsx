						...
						>
							<div className='w-full flex flex-col gap-4'>
								...
								<p className='flex-1 text-base font-normal'>
									Ideas de funciones impulsadas por IA basadas en el contexto de tu
									producto.
								</p>
							</div>
							...
							<button
								onClick={handleApply}
								disabled={!selectedId}
								className='btn text-base-50 outline outline-ai bg-ai disabled:opacity-50 disabled:cursor-not-allowed'
							>
