			...
			<div className='flex-1 px-0.5 flex flex-col gap-6'>
				...
				<div className='flex items-start justify-between gap-4'>
					<div className='flex flex-col gap-1'>
						<h2 className='text-neutral-800 text-3xl font-bold'>Nueva funcionalidad</h2>
					...
					<div className='flex flex-col gap-5'>
						...
						<div className='flex flex-col gap-2'>
							...
							<input
								...
								className={`w-full min-h-[44px] px-4 py-2.5 text-neutral-800 placeholder:text-neutral-400 bg-neutral-50 border rounded-md focus:ring-2 focus:outline-none transition-all duration-200 ${
									fieldErrors.title
							...
							<div className='flex justify-between items-center gap-2'>
								...
								<span
									className={`text-xs shrink-0 tabular-nums transition-colors duration-200 ${
										titleOver ? 'text-error-500 font-medium' : 'text-neutral-400'
									}`}
								>
									{titleCount}/50
								</span>
						...
						<div className='flex flex-col gap-2'>
							...
							<textarea
								...
								className={`w-full min-h-[160px] px-4 py-3 text-neutral-800 placeholder:text-neutral-400 bg-neutral-50 border rounded-md focus:ring-2 focus:outline-none transition-all duration-200 resize-none ${
							...
							<div className='flex justify-between items-center gap-2'>
								...
								<span
									className={`text-xs shrink-0 tabular-nums transition-colors duration-200 ${
										descOver ? 'text-error-500 font-medium' : 'text-neutral-400'
									}`}
								>
									{descCount}/500
								</span>
